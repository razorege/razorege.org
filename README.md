# razorege.org GitHub Pages website
...
The pages are hosted in the [gh-pages](https://github.com/razorege/razorege.org/tree/gh-pages) branch of this repository. You can monitor the building of this branch from markdown into static HTML on the [Actions](https://github.com/razorege/razorege.org/actions) page. When you are developing the pages locally then you can use Ruby and Jekyll to build and serve these pages locally. 
...
1. Get a local copy of the repository:
    ...
    `git clone git@github.com:razorege/razorege.org.git`
...
1. Create a pull request at GitHub by going to https://github.com/razorege/razorege.org/compare.  Change the 
...
1. Monitor [GitHub Actions](https://github.com/razorege/razorege.org/actions) to check that the changes are built, reported and deployed.

1. Your changes should now be available at https://razorege.org/.

1. In the PR page, or from the [branches](https://github.com/razorege/razorege.org/branches) page delete 
